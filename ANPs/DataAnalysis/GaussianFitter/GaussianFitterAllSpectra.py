...
def fit_all_heights(spectra_dict, wl_min=760, wl_max=840, num_gaussians=3, dark_rate=0.0003, read_noise=3.0,
    ...
    if results:
        ...
        for height, res in results.items():
            ...
            row = {
                'Height_mV': height,
                'baseline': popt[0], 'baseline_error': perr[0],
                'g1_amplitude': popt[1], 'g1_amplitude_error': perr[1],
                'g1_center_nm': popt[2], 'g1_center_error_nm': perr[2],
                'g1_sigma_nm': popt[3], 'g1_sigma_error_nm': perr[3],
                'g1_area': areas[0],
                'g2_amplitude': popt[4], 'g2_amplitude_error': perr[4],
                'g2_center_nm': popt[5], 'g2_center_error_nm': perr[5],
                'g2_sigma_nm': popt[6], 'g2_sigma_error_nm': perr[6],
                'g2_area': areas[1],
                'g3_amplitude': popt[7], 'g3_amplitude_error': perr[7],
                'g3_center_nm': popt[8], 'g3_center_error_nm': perr[8],
                'g3_sigma_nm': popt[9], 'g3_sigma_error_nm': perr[9],
                'g3_area': areas[2]
            }
            data.append(row)
